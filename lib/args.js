...
var argsToArray = require('./utils').argsToArray,
    validateValue = require('./utils').validateValue;
...
module.exports = function (proto) {
  ...
  proto.noise = function noise (radius) {
    var radiusType = validateValue(radius, _noises);

    var sign = radiusType ? "+" : "-";

    return this.out(sign + "noise", radiusType || radius);
  }
  ...
  proto.gravity = function gravity (type) {
    type = validateValue(type, _gravities, "NorthWest");
