  ...
  function compare(orig, compareTo, tolerance, cb) {
    ...
    if (typeof tolerance === 'object') {
      ...
      var highlightColorOption = diffOptions.highlightColor
        ...
        : ' ';
      var highlightStyleOption = diffOptions.highlightStyle
        ? ' -highlight-style ' + diffOptions.highlightStyle + ' '
        : ' ';
      ...
      var cmd = bin + 'compare' + highlightColorOption + highlightStyleOption + orig + ' ' + compareTo +
        ' ' + diffOpt;
