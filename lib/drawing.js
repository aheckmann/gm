...
module.exports = function (proto) {
  ...
  // http://www.graphicsmagick.org/GraphicsMagick.html#details-draw
  // decorate none|underline|overline|line-through - http://www.graphicsmagick.org/api/types.html#drawcontext
  proto.drawText = function drawText (x0, y0, text, gravity, decorate) {
    var decorate = decorate ? (this._decorate.indexOf(decorate) > -1 ? decorate : this._decorate[0]) : "",
