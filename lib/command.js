...
module.exports = function (proto) {
  ...
  proto.write = function write (name) {
    if (!name) {
    ...
    return new Promise(function writeResolution (resolve, reject) {
      this._preprocess(function preprocessCallback (err) {
        if (err) {
          return reject(err)	
        };
        return self._spawn(self.args(), true, resolve);
      });
    })
  }
